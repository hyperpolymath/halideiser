...
// Replace halideiser, Halideiser — See README.adoc for details., just run, Halideiser started successfully. with actuals
= halideiser — Quick Start for Users
:toc:
:toclevels: 2

== What is halideiser?

Halideiser — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./halideiser-portable
----
...
[source]
----
Halideiser started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/halideiser/wiki
