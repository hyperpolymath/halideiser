...
|`+src/interface/abi/Types.idr+` |Idris2 |Pipeline stage types,
scheduling primitives, hardware targets

|`+src/interface/abi/Layout.idr+` |Idris2 |Halide `+buffer_t+` memory
layout proofs

|`+src/interface/abi/Foreign.idr+` |Idris2 |FFI declarations for
...
|`+src/interface/ffi/test/+` |Zig |Integration tests verifying FFI
matches ABI

|`+src/interface/generated/abi/+` |C |Auto-generated headers from Idris2
ABI
...
|`+.machine_readable/+` |A2ML/TOML |State, ecosystem, policies, bot
directives
|===
