...
doctor:
    @echo "Running diagnostics for halideiser..."
...
heal:
    @echo "Attempting auto-repair for halideiser..."
...
help-me:
    @echo "=== halideiser Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/hyperpolymath/halideiser/issues/new"
    @echo ""
